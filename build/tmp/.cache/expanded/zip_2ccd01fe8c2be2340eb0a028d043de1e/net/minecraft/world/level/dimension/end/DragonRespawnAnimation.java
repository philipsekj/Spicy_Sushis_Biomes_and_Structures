         ...
         if (flag || flag1) {
            ...
            if (j < list.size()) {
               ...
               if (flag) {
                  ...
                  p_64035_.explode((Entity)null, (double)((float)endspike.getCenterX() + 0.5F), (double)endspike.getHeight(), (double)((float)endspike.getCenterZ() + 0.5F), 5.0F, Level.ExplosionInteraction.BLOCK);
                  SpikeConfiguration spikeconfiguration = new SpikeConfiguration(true, ImmutableList.of(endspike), new BlockPos(0, 128, 0));
                  Feature.END_SPIKE.place(spikeconfiguration, p_64035_, p_64035_.getChunkSource().getGenerator(), RandomSource.create(), new BlockPos(endspike.getCenterX(), 45, endspike.getCenterZ()));
               }
            } else if (flag) {
